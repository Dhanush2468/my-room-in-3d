...
export default class BouncingLogo
{
    ...
    setModel() {
        ...
        this.model.group.position.y = 2.7; // Adjusted position to move the logo up to the center
        ...
        this.model.geometry = new THREE.PlaneGeometry(4, 4, 2, 2)
    ...
    setAnimation() {
        ...
        this.animations.limits.y = { min: -0.947, max: 1.055 }; // Adjusted limits for decreasing y
      
        this.animations.speed = {};
        this.animations.speed.z = 0.00061;
        this.animations.speed.y = -0.00037; // Changed sign to make y decrease
